(function() {
  $(function() {
    /* General Site Stuffs */    var bookWidth, books, changePosition, currentPosition, moveBook, numberOfBooks, slideShowInterval, speed;
    ...
    return moveBook = function() {
      console.log('tst');
      return $('bookHolder').animate({
